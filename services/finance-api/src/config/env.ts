...
const env = {
  ...
  // SMS EXPERIENCE VARIABLES
  SMS_PROVIDER: process.env.SMS_PROVIDER || 'SMS_EXPERIENCE',
  SMS_EXPERIENCE_USERNAME: process.env.SMS_EXPERIENCE_USERNAME!,
  SMS_EXPERIENCE_PASSWORD: process.env.SMS_EXPERIENCE_PASSWORD!,
  SMS_EXPERIENCE_SENDER_ID: process.env.SMS_EXPERIENCE_SENDER_ID,
  SMS_EXPERIENCE_BASE_URL: process.env.SMS_EXPERIENCE_BASE_URL,
  
  OTP_EXPIRY_MINUTES: parseInt(process.env.OTP_EXPIRY_MINUTES || '10'),
  MAX_OTP_ATTEMPTS: parseInt(process.env.MAX_OTP_ATTEMPTS || '3'),
  OTP_CLEANUP_INTERVAL: parseInt(process.env.OTP_CLEANUP_INTERVAL || '300000'),
  
  // Optional: SMS Gateway Settings
  SMS_GATEWAY_TIMEOUT: parseInt(process.env.SMS_GATEWAY_TIMEOUT || '30000'),
  SMS_GATEWAY_RETRY_ATTEMPTS: parseInt(process.env.SMS_GATEWAY_RETRY_ATTEMPTS || '3'),
  SMS_GATEWAY_RETRY_DELAY: parseInt(process.env.SMS_GATEWAY_RETRY_DELAY || '2000'),
