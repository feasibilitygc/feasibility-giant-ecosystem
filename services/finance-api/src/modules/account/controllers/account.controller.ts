...
import { IAccountQueryFilters, ICreateAccountInput, IUpdateAccountInput } from '../interfaces/account.interface';
...
export class AccountController {
  ...
  getAccount = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
      const account = await this.accountService.getAccountById(id as string);
