import { prisma, TransactionType, TransactionStatus, TransactionModule, Prisma, Transaction } from '@/prisma';
  ...
  async updateTransactionStatus(
    ...
    try {
      ...
      if (status === 'COMPLETED') {
        ...
        return await this.prisma.$transaction(async (tx: { transaction: { update: (arg0: { where: { id: string; }; data: { status: "COMPLETED"; completedAt: Date; approver: { connect: { id: string; }; } | undefined; metadata: any; }; }) => any; }; }) => {
    ...
    try {
      ...
      return await this.prisma.$transaction(async (tx: {
          transaction: {
            create: (arg0: {
              data: {
                loanId: any; savingsId: any; sharesId: any; requestId?: any; id: string; transactionType: "REVERSAL"; baseType: "CREDIT" | "DEBIT"; // Opposite of the original
                module: any; amount: any; balanceAfter: Decimal; // Will be calculated by processor
                status: "COMPLETED"; description: string; metadata: { reversalReason: string; originalTransaction: { id: any; type: any; amount: any; }; }; initiatedBy: string; approvedBy: string; // Auto-approve reversals
                completedAt: Date; parentTxnId: any;
              };
            }) => any; update: (arg0: { where: { id: string; }; data: { status: "REVERSED"; }; }) => any;
          };
        }) => {
  ...
  private async processBatchAsUnit(transactions: CreateTransactionDto[]): Promise<Transaction[]> {
    ...
    return await this.prisma.$transaction(async (tx: {
        transaction: {
          create: (arg0: {
            data: {
              initiatedBy: string; status: "PENDING" | "COMPLETED"; completedAt: Date | null; sharesId?: string | undefined; savingsId?: string | undefined; loanId?: string | undefined; parentTxnId?: string | undefined; requestId?: string | undefined; id: string; transactionType: "CREDIT" | "DEBIT" | "SAVINGS_DEPOSIT" | "SAVINGS_WITHDRAWAL" | "SAVINGS_INTEREST" | "SHARES_PURCHASE" | "SHARES_LIQUIDATION" | "SHARES_DIVIDEND" | "LOAN_DISBURSEMENT" | "LOAN_REPAYMENT" | "LOAN_INTEREST" | "LOAN_PENALTY" | "FEE" | "REVERSAL" | "ADJUSTMENT" | "PERSONAL_SAVINGS_DEPOSIT" | "PERSONAL_SAVINGS_WITHDRAWAL"; baseType: TransactionType; module: "SAVINGS" | "SHARES" | "LOAN" | "SYSTEM" | "ADMIN"; amount: Decimal; balanceAfter: Decimal; // Will be updated by processor
              description: string | undefined; metadata: Prisma.InputJsonValue;
            };
          }) => any;
        };
      }) => {
